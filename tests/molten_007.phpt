...
?>
--EXPECTF--
{"traceId":"%s","name":"addServer","version":"%s","id":"%s","parentId":"%s","timestamp":%d,"duration":%d,"annotations":[{"value":"cs","timestamp":%d,"endpoint":{"serviceName":"test","ipv4":"%s"}},{"value":"cr","timestamp":%d,"endpoint":{"serviceName":"test","ipv4":"%s"}}],"binaryAnnotations":[{"key":"sa","value":"true","endpoint":{"serviceName":"memcache","ipv4":"%s","port":11242}},{"key":"db.statement","value":"addServer 10.209.37.22,11242,","endpoint":{"serviceName":"test","ipv4":"%s"}},{"key":"db.type","value":"memcache","endpoint":{"serviceName":"test","ipv4":"%s"}}]}
{"traceId":"%s","name":"add","version":"%s","id":"%s","parentId":"%s","timestamp":%d,"duration":%d,"annotations":[{"value":"cs","timestamp":%d,"endpoint":{"serviceName":"test","ipv4":"%s"}},{"value":"cr","timestamp":%d,"endpoint":{"serviceName":"test","ipv4":"%s"}}],"binaryAnnotations":[{"key":"db.statement","value":"add test-monitor-dddd,the key as long as possible, her...,0...","endpoint":{"serviceName":"test","ipv4":"%s"}},{"key":"db.type","value":"memcache","endpoint":{"serviceName":"test","ipv4":"%s"}},{"key":"error","value":"NOT STORED","endpoint":{"serviceName":"test","ipv4":"%s"}}]}
{"traceId":"%s","name":"addServer","version":"%s","id":"%s","parentId":"%s","timestamp":%d,"duration":%d,"annotations":[{"value":"cs","timestamp":%d,"endpoint":{"serviceName":"test","ipv4":"%s"}},{"value":"cr","timestamp":%d,"endpoint":{"serviceName":"test","ipv4":"%s"}}],"binaryAnnotations":[{"key":"sa","value":"true","endpoint":{"serviceName":"memcache","ipv4":"%s","port":11242}},{"key":"db.statement","value":"addServer 10.209.37.22,11242,","endpoint":{"serviceName":"test","ipv4":"%s"}},{"key":"db.type","value":"memcache","endpoint":{"serviceName":"test","ipv4":"%s"}}]}
