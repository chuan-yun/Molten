...
{"traceId":"%s","name":"file_get_contents","version":"%s","id":"%s","parentId":"%s","timestamp":%s,"duration":%s,"annotations":[{"value":"cs","timestamp":%s,"endpoint":{"serviceName":"test","ipv4":"%s"}},{"value":"cr","timestamp":%d,"endpoint":{"serviceName":"test","ipv4":"%s"}}],"binaryAnnotations":[{"key":"file.path","value":"%s","endpoint":{"serviceName":"test","ipv4":"%s"}}]}
